    ...
    <div className="w-10/12 mx-auto py-32">
      <div className="grid grid-cols-5 gap-4">
        ...
        <div className="col-span-3">
          <h1 className={`text-center text-4xl font-bold`}>{cerveza.nombre}</h1>
          <div className="grid grid-cols-3 mt-12">
            <div className="col-span-1 mt-10">
              <h2 className="text-xl font-bold">País</h2>
              <h2 className="text-xl font-bold">Tipo</h2>
              <h2 className="text-xl font-bold">Color</h2>
              <h2 className="text-xl font-bold">Graduación</h2>
            </div>
            <div className="col-span-1 mt-10">
              <h2 className="text-xl">{cerveza.pais}</h2>
              <h2 className="text-xl">{cerveza.tipo}</h2>
              <h2 className="text-xl">{cerveza.color}</h2>
              <h2 className="text-xl">{cerveza.graduacion}</h2>
            </div>
        ...
        <div className="col-span-1 md:col-span-5">
          <h1 className="text-font-bold text-4xl">Descripción</h1>
          <p className={`text-lg mt-5`}>{cerveza.descripcion}</p>
        </div>
      </div>
    </div>
  );
